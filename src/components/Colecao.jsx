...
export default function Colecao() {
  ...
  <div className="max-w-[1200px] mx-auto text-center">
    ...
    <div>
      <p className="text-[#474747] font-semibold mb-4 text-lg">Coleções em Destaque</p>
      <div className="flex flex-row justify-center items-center gap-8 flex-wrap">
        <div className="flex flex-col items-center">
          <img
            src="https://raw.githubusercontent.com/jotaveeo/imagens-projeto/main/public/camisa_1.svg"
            alt="camiseta"
            className="w-12 h-12"
          />
