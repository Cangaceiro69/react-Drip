      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <div className="flex space-x-4">
            {/* Facebook */}
            <a href="https://www.facebook.com/login/?locale=pt_BR" className="text-gray-400 hover:text-white" aria-label="Facebook">
            ...
            {/* Twitter */}
            <a href="https://x.com/i/flow/login" className="text-gray-400 hover:text-white" aria-label="Twitter">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* Instagram */}
            <a href="https://www.instagram.com/accounts/login/" className="text-gray-400 hover:text-white" aria-label="Instagram">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
